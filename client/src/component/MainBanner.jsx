...
{/* <div className='hidden md:block absolute h-full w-full bg-primary/15 left-0 -z-0'></div> */}
        <h1 className='z-1 text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left max-w-72 md:max-w-80  lg:max-w-105 leading-tight lg:leading-15 '>Freshness You Can Trust, Savings You will Love! </h1>
    <div className='z-1 flex items-center mt-6 font-medium'>
        ...
        <Link to={"/products"} className='group hidden md:flex items-center gap-2 md:px-9 py-3 cursor-pointer'>Explore deals
